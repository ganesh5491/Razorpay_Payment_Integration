...
//   const [selectedPaymentMethod, setSelectedPaymentMethod] = useState<"upi" | "qr" | "card" | "cod" | "apps" | null>(null);
...
//         } else if (selectedPaymentMethod === "apps") {
//           setLocation('/payment-apps');
    ...
    onSuccess: async (data) => {
      if (data.success) {
        ...
        if (selectedPaymentMethod === "card") {
          ...
          // Redirect based on other payment methods
          if (selectedPaymentMethod === "cod") {
            setLocation('/cod-confirmation');
          } else if (selectedPaymentMethod === "upi") {
            setLocation('/upi-payment');
